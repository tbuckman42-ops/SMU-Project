...
class home_page(home_pageTemplate):
  ...
  def course_id_dd_change(self, **event_args):
    ...
    if course_id is None:
      ...
      self.student_name_dd.items = []
      return
    self.group_name_dd.items = anvil.server.call("get_groups_for_course", course_id)
    self.student_name_dd.items = []
  ...
  def group_name_dd_change(self, **event_args):
    ...
    if group_name is None:
      self.student_name_dd.items = []
      return
    self.student_name_dd.items = anvil.server.call("get_students_for_group_home", group_name)
  ...
  def create_eval_btn_click(self, **event_args):
    ...
    if course_id is None or group_name is None or due_at is None:
      ...
      return
    try:
      result = anvil.server.call("create_evaluation", course_id, group_name, due_at)
      anvil.open_form(
        "eval_form_final",
